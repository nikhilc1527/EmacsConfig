...

;;;### (autoloads nil "make-it-so" "make-it-so.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "make-it-so" '("mis-")))

;;;***

;;;### (autoloads nil nil ("make-it-so-pkg.el") (0 0 0 0))
